...
const PREVENTAS_ACTIVAS = [
  ...
  {
    id: "scream-30-anios-cinemex",
    active: true,
    emoji: "👻",
    titulo: "Preventa: Scream 30 años – Cinemex",
    texto: "Ya puedes apartar el coleccionable por los <strong>30 años de Scream</strong> en Cinemex.<br><br>Edición especial para fans del slasher: reserva antes de que se agote.",
    link: "preventas.html",
    linkTexto: "Ver términos de preventa",
    tema: "cinemex",
  }
